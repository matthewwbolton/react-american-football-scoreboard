    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button onClick = {() => setHomeScore(homeScore + 1)}>Home PAT</button>
          <button onClick = {() => setHomeScore(homeScore + 2)}>Home 2-Point Conversion</button>
        ...
        <div className="awayButtons">
          ...
          <button onClick = {() => setAwayScore(awayScore + 1)}>Away PAT</button>
          <button onClick = {() => setHomeScore(homeScore + 2)}>Home 2-Point Conversion</button>
